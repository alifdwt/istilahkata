...
interface UnclearErrorProps {
  error: Error & { digest?: string };
  reset: () => void;
}

export default function UnclearError({ error, reset }: UnclearErrorProps) {
  return (
    <section>
      ...
      <div className="rounded-xl border bg-card p-6">
        <div className="rounded-lg border-2 border-destructive/20 bg-destructive/5 p-6 text-center">
          ...
          <h4 className="mb-2 text-lg font-semibold text-destructive">
            Gagal Memuat Kata yang Butuh Bantuan
          </h4>

          <p className="mb-4 text-sm text-muted-foreground">
            Terjadi kesalahan saat mengambil daftar kata yang membutuhkan
            penjelasan.
          </p>
